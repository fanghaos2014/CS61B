...
public class DList {
   ...
   */
  public DList() {
    this.head = newNode(Integer.MIN_VALUE,null,null);
    head.next=head;
    head.prev=head;
    size=0;
  }
  ...
  public void insertFront(Object item) {
    DListNode h1=newNode(item,head,head.next);
    head.next=h1;
  ...
  public void insertBack(Object item) {
    DListNode back1=newNode(item,head.prev,head);
