...
public class AdjList extends List {
   ...
   **/
  protected AdjListNode newNode(Object item, AdjList list,
                              AdjListNode prev, AdjListNode next) {
    return new AdjListNode(item, list, prev, next);
  }
  ...
  public void insertFront(Object item) {
    AdjListNode x = newNode(item, this, head, head.next);
    x.next.prev = x;
    x.prev.next = x;
    size++;
  }
  ...
  public void insertBack(Object item) {
    AdjListNode x = newNode(item, this, head.prev, head);
    x.next.prev = x;
    x.prev.next = x;
    size++;
  }
