...
public class AdjListNode extends ListNode {
  ...
  protected AdjListNode prev;
  protected AdjListNode next;
  public DList adjList = new DList();
   ...
   */
  AdjListNode(Object i, AdjList l, AdjListNode p, AdjListNode n) {
    item = i;
    myList = l;
    prev = p;
    next = n;
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    if (!isValidNode()) {
      ...
      AdjListNode x = new AdjListNode(item, (AdjList) myList, this, this.next);
      x.prev.next = x;
      x.next.prev = x;
    }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    if (!isValidNode()) {
      ...
      AdjListNode x = new AdjListNode(item, (AdjList) myList, this.prev, this);
      x.prev.next = x;
      x.next.prev = x;
    }
    // Your solution here.  Will look something like your Homework 4 solution,
